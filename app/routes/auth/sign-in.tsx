        ...
        <Card variant="elevated" className="bg-surface-900 border-surface-800">
          <CardContent>
            <div className="text-center mb-6">
              ...
              <p className="text-surface-400 text-sm mt-1">Entre na sua conta para continuar</p>
            </div>
            ...
            <div className="mt-6 text-center text-sm text-surface-400">
              Não tem uma conta?{" "}
              <Link to="/auth/sign-up" className="text-primary-400 hover:text-primary-300 font-medium">
                Criar conta
              </Link>
            </div>
          </CardContent>
